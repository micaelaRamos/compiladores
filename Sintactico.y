...
char *_constante;
ptrNodoArbol _ptrAsignacion;
ptrNodoArbol _ptrAsignacionLinea;
ptrNodoArbol _ptrSentencia;
ptrNodoArbol _ptrArbol;
ptrNodoArbol _ptrHoja;
...
char* intAString(float numero)
{
  char array[10];
  sprintf(array, "%d", numero);
  return &array;
};